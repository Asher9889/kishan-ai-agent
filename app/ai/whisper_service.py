...
class WhisperService:
    ...
    def transcribe_pcm(self, pcm_buffer, sample_rate: int = 48000) -> dict[str, str | float]:
        ...
        segments, info = self.model.transcribe(
            ...
            initial_prompt=(
                "यह कृषि सलाहकार की बातचीत है। हिंदी भाषा में "
                "सामान्य शब्द: "
                "गेहूं, धान, चावल, मक्का, बाजरा, ज्वार, चना, अरहर, मूंग, उड़द, मसूर, सरसों, सोयाबीन, तिल, मूंगफली, कपास, गन्ना"
                ...
                "सिंचाई, बुवाई, रोपाई, कटाई, निराई, गुड़ाई, मंडी, एमएसपी, मिट्टी परीक्षण,कृषि विज्ञान केंद्र, मौसम, मिट्टी परीक्षण "
